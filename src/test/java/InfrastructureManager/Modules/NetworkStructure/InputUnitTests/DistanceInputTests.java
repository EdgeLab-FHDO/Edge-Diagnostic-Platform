...
public class DistanceInputTests {
	...
	@Test
	public void getDistanceBetweenDevicesTest() throws ModuleExecutionException, InterruptedException {
		updateNetwork();
	...
	@Test
	public void getDistanceBetweenApplicationsTest() throws ModuleExecutionException, InterruptedException {
		updateNetwork();
		sharedNetwork.UpdateSharedNetworkObject(network);
	...
	@Test
	public void getDistanceBetweenLocationsTest() throws ModuleExecutionException, InterruptedException {
		updateNetwork();
		sharedNetwork.UpdateSharedNetworkObject(network);
...
//		output.execute("distance network Connection1 Connection2");
//		String expectedString = "distance 0.0";
//		Assert.assertEquals(expectedString, input.read());
//	}
